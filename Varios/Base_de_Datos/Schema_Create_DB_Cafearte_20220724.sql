CREATE DATABASE  IF NOT EXISTS `cafearte_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cafearte_db`;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_rols_id_foreign` FOREIGN KEY (`rols_id`) REFERENCES `rols` (`rols_id`)
...
-- Dump completed on 2022-07-24  8:37:07
